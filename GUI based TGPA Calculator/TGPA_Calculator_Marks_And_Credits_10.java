...
public class TGPA_Calculator_Marks_And_Credits_10 extends Layout implements KeyListener, MouseListener{  
    ...
    // 7th Line
    JTextField Text_Field_for_Marks_of_Subject7;
    JTextField Text_Field_for_Credits_of_Subject7;
    JLabel Sub7_Marks_Error_Text;
    JLabel Sub7_Credits_Error_Text;


    // 8th Line
    JTextField Text_Field_for_Marks_of_Subject8;
    JTextField Text_Field_for_Credits_of_Subject8;
    JLabel Sub8_Marks_Error_Text;
    JLabel Sub8_Credits_Error_Text;


    // 9th Line
    JTextField Text_Field_for_Marks_of_Subject9;
    JTextField Text_Field_for_Credits_of_Subject9;
    JLabel Sub9_Marks_Error_Text;
    JLabel Sub9_Credits_Error_Text;


    // 10th Line
    JTextField Text_Field_for_Marks_of_Subject10;
    JTextField Text_Field_for_Credits_of_Subject10;
    JLabel Sub10_Marks_Error_Text;
    JLabel Sub10_Credits_Error_Text;
    ...
    boolean m1_1, m1_2, m1_3, m1_4, m1_5, m1_6, m1_7, m1_8, m1_9, m1_10, c1_1, c1_2, c1_3, c1_4, c1_5, c1_6, c1_7, c1_8, c1_9, c1_10;

    boolean m2_1, m2_2, m2_3, m2_4, m2_5, m2_6, m2_7, m2_8, m2_9, m2_10, c2_1, c2_2, c2_3, c2_4, c2_5, c2_6, c2_7, c2_8, c2_9, c2_10;


    TGPA_Calculator_Marks_And_Credits_10(){
        ...
        Heading_label.setText("<html> <center> <br> * Enter Your Marks of Each Subject out of 100 <br> and Their Credits: <br> <br> Marks    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;     Credits </center> </html>");              // Sets the Text which has to be displayed Inside the Label 
        ...
        Heading_label.setPreferredSize(new Dimension(360, 100));           // Setting Size of Label 
        ...
        if(a == 10){    
            ...
            // Creating 13th Text Field for Marks of 7th Subject 
            Text_Field_for_Marks_of_Subject7 = new JTextField();
            Text_Field_for_Marks_of_Subject7.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Marks_of_Subject7.setForeground(new Color(255, 255, 255));
            Text_Field_for_Marks_of_Subject7.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Marks_of_Subject7.setText("Enter Marks of 7th Subject");
            Text_Field_for_Marks_of_Subject7.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Marks_of_Subject7.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Marks_of_Subject7);

            // Creating 14th Text Field for Credits of 7th Subject 
            Text_Field_for_Credits_of_Subject7 = new JTextField();
            Text_Field_for_Credits_of_Subject7.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Credits_of_Subject7.setForeground(new Color(255, 255, 255));
            Text_Field_for_Credits_of_Subject7.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Credits_of_Subject7.setText("Enter Credits of 7th Subject");
            Text_Field_for_Credits_of_Subject7.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Credits_of_Subject7.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Credits_of_Subject7);


            // Label for Displaying Error of 7th Subject's Marks
            Sub7_Marks_Error_Text = new JLabel(); 
            Sub7_Marks_Error_Text.setPreferredSize(new Dimension(158, 10));

            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub7_Marks_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub7_Marks_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub7_Marks_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub7_Marks_Error_Text);


            // Label for Displaying Error of 7th Subject's Credits
            Sub7_Credits_Error_Text = new JLabel(); 
            Sub7_Credits_Error_Text.setPreferredSize(new Dimension(158, 10));
            
            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub7_Credits_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub7_Credits_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub7_Credits_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub7_Credits_Error_Text);



            // 8th Line 

            // Creating 15th Text Field for Marks of 8th Subject 
            Text_Field_for_Marks_of_Subject8 = new JTextField();
            Text_Field_for_Marks_of_Subject8.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Marks_of_Subject8.setForeground(new Color(255, 255, 255));
            Text_Field_for_Marks_of_Subject8.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Marks_of_Subject8.setText("Enter Marks of 8th Subject");
            Text_Field_for_Marks_of_Subject8.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Marks_of_Subject8.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Marks_of_Subject8);

            // Creating 16th Text Field for Credits of 8th Subject 
            Text_Field_for_Credits_of_Subject8 = new JTextField();
            Text_Field_for_Credits_of_Subject8.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Credits_of_Subject8.setForeground(new Color(255, 255, 255));
            Text_Field_for_Credits_of_Subject8.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Credits_of_Subject8.setText("Enter Credits of 8th Subject");
            Text_Field_for_Credits_of_Subject8.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Credits_of_Subject8.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Credits_of_Subject8);


            // Label for Displaying Error of 8th Subject's Marks
            Sub8_Marks_Error_Text = new JLabel(); 
            Sub8_Marks_Error_Text.setPreferredSize(new Dimension(158, 10));

            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub8_Marks_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub8_Marks_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub8_Marks_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub8_Marks_Error_Text);


            // Label for Displaying Error of 8th Subject's Credits
            Sub8_Credits_Error_Text = new JLabel(); 
            Sub8_Credits_Error_Text.setPreferredSize(new Dimension(158, 10));
            
            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub8_Credits_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub8_Credits_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub8_Credits_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub8_Credits_Error_Text);



            // 9th Line 

            // Creating 17th Text Field for Marks of 9th Subject 
            Text_Field_for_Marks_of_Subject9 = new JTextField();
            Text_Field_for_Marks_of_Subject9.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Marks_of_Subject9.setForeground(new Color(255, 255, 255));
            Text_Field_for_Marks_of_Subject9.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Marks_of_Subject9.setText("Enter Marks of 9th Subject");
            Text_Field_for_Marks_of_Subject9.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Marks_of_Subject9.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Marks_of_Subject9);

            // Creating 18th Text Field for Credits of 9th Subject 
            Text_Field_for_Credits_of_Subject9 = new JTextField();
            Text_Field_for_Credits_of_Subject9.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Credits_of_Subject9.setForeground(new Color(255, 255, 255));
            Text_Field_for_Credits_of_Subject9.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Credits_of_Subject9.setText("Enter Credits of 9th Subject");
            Text_Field_for_Credits_of_Subject9.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Credits_of_Subject9.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Credits_of_Subject9);


            // Label for Displaying Error of 9th Subject's Marks
            Sub9_Marks_Error_Text = new JLabel(); 
            Sub9_Marks_Error_Text.setPreferredSize(new Dimension(158, 10));

            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub9_Marks_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub9_Marks_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub9_Marks_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub9_Marks_Error_Text);


            // Label for Displaying Error of 9th Subject's Credits
            Sub9_Credits_Error_Text = new JLabel(); 
            Sub9_Credits_Error_Text.setPreferredSize(new Dimension(158, 10));
            
            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub9_Credits_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub9_Credits_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub9_Credits_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub9_Credits_Error_Text);



            // 10th Line 

            // Creating 19th Text Field for Marks of 10th Subject 
            Text_Field_for_Marks_of_Subject10 = new JTextField();
            Text_Field_for_Marks_of_Subject10.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Marks_of_Subject10.setForeground(new Color(255, 255, 255));
            Text_Field_for_Marks_of_Subject10.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Marks_of_Subject10.setText("Enter Marks of 10th Subject");
            Text_Field_for_Marks_of_Subject10.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Marks_of_Subject10.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Marks_of_Subject10);

            // Creating 20th Text Field for Credits of 10th Subject 
            Text_Field_for_Credits_of_Subject10 = new JTextField();
            Text_Field_for_Credits_of_Subject10.setBackground(new Color(0, 0, 0)); 
            Text_Field_for_Credits_of_Subject10.setForeground(new Color(255, 255, 255));
            Text_Field_for_Credits_of_Subject10.setPreferredSize(new Dimension(158, 20)); 
            Text_Field_for_Credits_of_Subject10.setText("Enter Credits of 10th Subject");
            Text_Field_for_Credits_of_Subject10.setFont(new Font("Segoe UI", Font.PLAIN, 10));
            Text_Field_for_Credits_of_Subject10.addKeyListener(this);
            Text_Field_And_Heading_Holder.add(Text_Field_for_Credits_of_Subject10);


            // Label for Displaying Error of 10th Subject's Marks
            Sub10_Marks_Error_Text = new JLabel(); 
            Sub10_Marks_Error_Text.setPreferredSize(new Dimension(158, 10));
            
            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub10_Marks_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub10_Marks_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub10_Marks_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub10_Marks_Error_Text);


            // Label for Displaying Error of 10th Subject's Credits
            Sub10_Credits_Error_Text = new JLabel(); 
            Sub10_Credits_Error_Text.setPreferredSize(new Dimension(158, 10));
            
            if(Apps_Color==3 || Apps_Color==4 || Apps_Color==0){
                Sub10_Credits_Error_Text.setForeground(new Color(255, 0, 0)); 
            }
            else if(Apps_Color==1 || Apps_Color==2 || Apps_Color==5){
                Sub10_Credits_Error_Text.setForeground(new Color(255, 255, 255)); 
            }

            Sub10_Credits_Error_Text.setFont(new Font("Segoe UI", Font.PLAIN, 8));
            Text_Field_And_Heading_Holder.add(Sub10_Credits_Error_Text);
    ...
    public void keyPressed(KeyEvent e) {  // Here we are restricting user to only type numeric values in TextField 
        ...
        if(e.getSource()==Text_Field_for_Marks_of_Subject1){
            ...
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                ...
                if(m1_1 && m1_2 && m1_3 && m1_4 && m1_5 && m1_6 && m1_7 && m1_8 && m1_9 && m1_10 && c1_1 && c1_2 && c1_3 && c1_4 && c1_5 && c1_6 && c1_7 && c1_8 && c1_9 && c1_10 && m2_1 && m2_2 && m2_3 && m2_4 && m2_5 && m2_6 && m2_7 && m2_8 && m2_9 && m2_10 && c2_1 && c2_2 && c2_3 && c2_4 && c2_5 && c2_6 && c2_7 && c2_8 && c2_9 && c2_10){
        ...
        // 7th Subject's Marks 
        if(e.getSource()==Text_Field_for_Marks_of_Subject7){
            char c = e.getKeyChar();
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Marks_of_Subject7.setEditable(true);
                Sub7_Marks_Error_Text.setText("");
                ...
                Text_Field_for_Marks_of_Subject7.setText("");
                Sub7_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 7th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject7){
            char c = e.getKeyChar();
            if (c >= '1' && c <= '5' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Credits_of_Subject7.setEditable(true);
                Sub7_Credits_Error_Text.setText("");
                ...
                Text_Field_for_Credits_of_Subject7.setText("");
                Sub7_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
        ...
        // 8th Subject's Marks 
        if(e.getSource()==Text_Field_for_Marks_of_Subject8){
            char c = e.getKeyChar();
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Marks_of_Subject8.setEditable(true);
                Sub8_Marks_Error_Text.setText("");
                ...
                Text_Field_for_Marks_of_Subject8.setText("");
                Sub8_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 8th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject8){
            char c = e.getKeyChar();
            if (c >= '1' && c <= '5' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Credits_of_Subject8.setEditable(true);
                Sub8_Credits_Error_Text.setText("");
                ...
                Text_Field_for_Credits_of_Subject8.setText("");
                Sub8_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
        ...
        // 9th Subject's Marks 
        if(e.getSource()==Text_Field_for_Marks_of_Subject9){
            char c = e.getKeyChar();
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Marks_of_Subject9.setEditable(true);
                Sub9_Marks_Error_Text.setText("");
                ...
                Text_Field_for_Marks_of_Subject9.setText("");
                Sub9_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 9th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject9){
            char c = e.getKeyChar();
            if (c >= '1' && c <= '5' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Credits_of_Subject9.setEditable(true);
                Sub9_Credits_Error_Text.setText("");
                ...
                Text_Field_for_Credits_of_Subject9.setText("");
                Sub9_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
        ...
        // 10th Subject's Marks 
        if(e.getSource()==Text_Field_for_Marks_of_Subject10){
            char c = e.getKeyChar();
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Marks_of_Subject10.setEditable(true);
                Sub10_Marks_Error_Text.setText("");
                ...
                Text_Field_for_Marks_of_Subject10.setText("");
                Sub10_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 10 Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject10){
            char c = e.getKeyChar();
            if (c >= '1' && c <= '5' || c == KeyEvent.VK_BACK_SPACE) {
                Text_Field_for_Credits_of_Subject10.setEditable(true);
                Sub10_Credits_Error_Text.setText("");
                ...
                Text_Field_for_Credits_of_Subject10.setText("");
                Sub10_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
    ...
    public void keyReleased(KeyEvent e) {  // Here we are restricting user to just enter number in range 1-100 for marks and 1-5 for credits
        ...
        // 7th Subject's Marks
        if(e.getSource()==Text_Field_for_Marks_of_Subject7){
            String value = Text_Field_for_Marks_of_Subject7.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 0 || number > 100) {
                    Sub7_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 7th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject7){
            String value = Text_Field_for_Credits_of_Subject7.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 1 || number > 5) {
                    Sub7_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
        ...
        // 8th Subject's Marks
        if(e.getSource()==Text_Field_for_Marks_of_Subject8){
            String value = Text_Field_for_Marks_of_Subject8.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 0 || number > 100) {
                    Sub8_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 8th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject8){
            String value = Text_Field_for_Credits_of_Subject8.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 1 || number > 5) {
                    Sub8_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
        ...
        // 9th Subject's Marks
        if(e.getSource()==Text_Field_for_Marks_of_Subject9){
            String value = Text_Field_for_Marks_of_Subject9.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 0 || number > 100) {
                    Sub9_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 9th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject9){
            String value = Text_Field_for_Credits_of_Subject9.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 1 || number > 5) {
                    Sub9_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
        ...
        // 10th Subject's Marks
        if(e.getSource()==Text_Field_for_Marks_of_Subject10){
            String value = Text_Field_for_Marks_of_Subject10.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 0 || number > 100) {
                    Sub10_Marks_Error_Text.setText("* Enter only whole no.s between 0-100");
        ...
        // 10th Subject's Credits
        if(e.getSource()==Text_Field_for_Credits_of_Subject10){
            String value = Text_Field_for_Credits_of_Subject10.getText();
            try {
                int number = Integer.parseInt(value);
                if (number < 1 || number > 5) {
                    Sub10_Credits_Error_Text.setText("* Enter only whole no.s between 1-5");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Submit){
            if(a == 10){
                ...
                double m7 = Double.parseDouble(Text_Field_for_Marks_of_Subject7.getText());
                double c7 = Double.parseDouble(Text_Field_for_Credits_of_Subject7.getText());
                double m8 = Double.parseDouble(Text_Field_for_Marks_of_Subject8.getText());
                double c8 = Double.parseDouble(Text_Field_for_Credits_of_Subject8.getText());
                double m9 = Double.parseDouble(Text_Field_for_Marks_of_Subject9.getText());
                double c9 = Double.parseDouble(Text_Field_for_Credits_of_Subject9.getText());
                double m10 = Double.parseDouble(Text_Field_for_Marks_of_Subject10.getText());
                double c10 = Double.parseDouble(Text_Field_for_Credits_of_Subject10.getText());
    
                double credit_sum = (c1 + c2 + c3 + c4 + c5 + c6 + c7 + c8 + c9 + c10);
                ...
                double s7_TGPA = Math.floor(m7 / 9);
                double s8_TGPA = Math.floor(m8 / 9);
                double s9_TGPA = Math.floor(m9 / 9);
                double s10_TGPA = Math.floor(m10 / 9);
    
    
                double multiple_sum = ((s1_TGPA*c1)+(s2_TGPA*c2)+(s3_TGPA*c3)+(s4_TGPA*c4)+(s5_TGPA*c5)+(s6_TGPA*c6)+(s7_TGPA*c7)+(s8_TGPA*c8)+(s9_TGPA*c9)+(s10_TGPA*c10));
