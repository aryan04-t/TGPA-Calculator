...
public class TGPA_Calculator_Marks_And_Credits_2 extends Layout implements KeyListener, MouseListener{  
    ...
    boolean m1_1, m1_2, c1_1, c1_2;

    boolean m2_1, m2_2, c2_1, c2_2;


    TGPA_Calculator_Marks_And_Credits_2(){
        ...
        Heading_label.setPreferredSize(new Dimension(360, 260));           // Setting Size of Label 
    ...
    public void keyPressed(KeyEvent e) {  // Here we are restricting user to only type numeric values in TextField 
        ...
        if(e.getSource()==Text_Field_for_Marks_of_Subject1){
            ...
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                ...
                if(m1_1 && m1_2 && c1_1 && c1_2 && m2_1 && m2_2 && c2_1 && c2_2){
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Submit){
            if(a == 2){
                ...
                double credit_sum = (c1 + c2);
    
                double s1_TGPA = Math.floor(m1 / 9);
                double s2_TGPA = Math.floor(m2 / 9);
    
    
                double multiple_sum = ((s1_TGPA*c1)+(s2_TGPA*c2));
