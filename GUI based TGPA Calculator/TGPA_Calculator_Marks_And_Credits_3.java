...
public class TGPA_Calculator_Marks_And_Credits_3 extends Layout implements KeyListener, MouseListener{  
    ...
    boolean m1_1, m1_2, m1_3, c1_1, c1_2, c1_3;

    boolean m2_1, m2_2, m2_3, c2_1, c2_2, c2_3;


    TGPA_Calculator_Marks_And_Credits_3(){
        ...
        Heading_label.setText("<html> <center> <br> <br> <br> <br> * Enter Your Marks of Each Subject out of 100 <br> and Their Credits: <br> <br> <br> Marks    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;     Credits </center> </html>");              // Sets the Text which has to be displayed Inside the Label 
    ...
    public void keyPressed(KeyEvent e) {  // Here we are restricting user to only type numeric values in TextField 
        ...
        if(e.getSource()==Text_Field_for_Marks_of_Subject1){
            ...
            if (c >= '0' && c <= '9' || c == KeyEvent.VK_BACK_SPACE) {
                ...
                if(m1_1 && m1_2 && m1_3 && c1_1 && c1_2 && c1_3 && m2_1 && m2_2 && m2_3 && c2_1 && c2_2 && c2_3){
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Submit){
            if(a == 3){
                ...
                double multiple_sum = ((s1_TGPA*c1)+(s2_TGPA*c2)+(s3_TGPA*c3));
